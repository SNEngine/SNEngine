...
{
    [CustomNodeEditor(typeof(FadeCharacterInOutNode))]
    public class FadeCharacterInOutNodeEditor : NodeEditor
    {
        public override void OnBodyGUI()
        {
            serializedObject.Update();
            FadeCharacterInOutNode node = target as FadeCharacterInOutNode;
