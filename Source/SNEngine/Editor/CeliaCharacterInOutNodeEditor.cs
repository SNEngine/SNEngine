...
using SNEngine.CharacterSystem.Animations.Celia;
using UnityEditor;
using UnityEngine;
using XNodeEditor;
...
{
    [CustomNodeEditor(typeof(CeliaCharacterInOutNode))]
    public class CeliaCharacterInOutNodeEditor : NodeEditor
    {
        public override void OnBodyGUI()
        {
            serializedObject.Update();

            CeliaCharacterInOutNode node = target as CeliaCharacterInOutNode;
