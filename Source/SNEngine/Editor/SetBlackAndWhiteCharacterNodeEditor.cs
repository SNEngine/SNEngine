...
{
    [CustomNodeEditor(typeof(SetBlackAndWhiteCharacterNode))]
    public class SetBlackAndWhiteCharacterNodeEditor : NodeEditor
    {
        public override void OnBodyGUI()
        {
            serializedObject.Update();

            SetBlackAndWhiteCharacterNode node = target as SetBlackAndWhiteCharacterNode;
