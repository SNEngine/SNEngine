...
using SNEngine.CharacterSystem.Animations.BlackAndWhite;
using UnityEditor;
using UnityEngine;
using XNodeEditor;
...
{
    [CustomNodeEditor(typeof(SetBlackAndWhiteCharacterInOutNode))]
    public class SetBlackAndWhiteCharacterInOutNodeEditor : NodeEditor
    {
        public override void OnBodyGUI()
        {
            serializedObject.Update();

            SetBlackAndWhiteCharacterInOutNode node = target as SetBlackAndWhiteCharacterInOutNode;
